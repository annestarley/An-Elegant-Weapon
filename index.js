...
button0.addEventListener('click', function() {
  ...
  imgs[0].setAttribute('src', 'images/vocation/senator.jpg')
  ...
  imgs[1].setAttribute('src', 'images/vocation/bountyhunter.jpg')
  ...
  imgs[2].setAttribute('src', 'images/vocation/musician.jpg')
  ...
  imgs[3].setAttribute('src', 'images/vocation/beauty.png')
  ...
  imgs[4].setAttribute('src', 'images/vocation/pilot.jpeg')
...
button2.addEventListener('click', function() {
  ...
  imgs2[0].setAttribute('src', 'images/movies/episode1.png')
  ...
  imgs2[1].setAttribute('src', 'images/movies/episode2.jpg')
  ...
  imgs2[2].setAttribute('src', 'images/movies/clonewars.jpg')
  ...
  imgs2[3].setAttribute('src', 'images/movies/episode3.jpg')
  ...
  imgs2[4].setAttribute('src', 'images/movies/rogueone.png')
  ...
  imgs2[5].setAttribute('src', 'images/movies/episode4.jpg')
  ...
  imgs2[6].setAttribute('src', 'images/movies/episode5.jpg')
  ...
  imgs2[7].setAttribute('src', 'images/movies/episode6.jpg')
  ...
  imgs2[8].setAttribute('src', 'images/movies/episode7.jpg')
  ...
  imgs2[9].setAttribute('src', 'images/movies/episode8.jpg')
...
button4.addEventListener('click', function() {
  ...
  imgs5[0].setAttribute('src', 'images/vacation/felucia.jpeg')
  ...
  imgs5[1].setAttribute('src', 'images/vacation/naboo.jpeg')
  ...
  imgs5[2].setAttribute('src', 'images/vacation/alderaan.jpg')
  ...
  imgs5[3].setAttribute('src', 'images/vacation/endor.jpg')
  ...
  imgs5[4].setAttribute('src', 'images/vacation/coruscant.jpeg')
...
button5.addEventListener('click', function() {
  ...
  r2d2.setAttribute('src', 'images/droids/r2d2.jpg')
  ...
  bb8.setAttribute('src', 'images/droids/bb8.jpg')
...
button6.addEventListener('click', function() {
  ...
  if (answers[0] === '' && answers[1] === '' && answers[2] === '' && answers[3] === '' && answers[4] === '') {
    ...
    ansImg.setAttribute('src', 'images/weapons/blaster.png')
    ...
    ansImg.setAttribute('src', 'images/weapons/darksaber.jpg')
    ...
    if (answers[3] === ('coruscant' || 'alderaan')) {
      ...
      ansImg.setAttribute('src', 'images/weapons/greendouble.jpg')
      ...
      ansImg.setAttribute('src', 'images/weapons/greensingle.jpg')
    ...
    if (answers[3] === ('endor' || 'felucia')) {
      ...
      ansImg.setAttribute('src', 'images/weapons/bluedouble.jpg')
      ansImg.setAttribute('alt', 'blue double-bladed lightsaber')
      ansImg.setAttribute('style', 'height: 300px;')
      ansParagraph.innerText = ""
    } else {
      ansHeader.innerText = 'BLUE SINGLE-BLADED LIGHTSABER'
      ansImg.setAttribute('src', 'images/weapons/bluesingle.jpg')
    ...
    if (answers[3] === ('naboo' || 'felucia')) {
      ...
      ansImg.setAttribute('src', 'images/weapons/reddouble.jpg')
      ...
      ansImg.setAttribute('src', 'images/weapons/redcrossgaurd.png')
      ansImg.setAttribute('alt', 'red cross-guard lightsaber')
      ansImg.setAttribute('style', 'height: 300px;')
      ansParagraph.innerText = ""
    } else {
      ansHeader.innerText = 'RED SINGLE-BLADED LIGHTSABER'
      ansImg.setAttribute('src', 'images/weapons/redsingle.png')
    ...
    ansImg.setAttribute('src', 'images/weapons/purple.jpg')
    ...
    if (answers[4] === ('BB8')) {
      ...
      ansImg.setAttribute('src', 'images/weapons/yellowdouble.png')
      ansImg.setAttribute('alt', 'yellow pike-staff lightsaber')
      ansImg.setAttribute('style', 'height: 300px;')
      ansParagraph.innerText = ""
    } else {
      ansHeader.innerText = 'WHITE SINGLE-BLADED LIGHTSABER'
      ansImg.setAttribute('src', 'images/weapons/whitesingle.jpg')
    ...
    ansImg.setAttribute('src', 'images/weapons/yellowsingle.jpg')
